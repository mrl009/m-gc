...
$("#<?php echo $id;?>").DataSource({url:'order/getlist',
	fields:[[
		...
		{type:'combobox',text:'來源',width:100,name:'verify_status',value:'', items:'<option value="">全部</option><option value="1">IOS端</option><option value="2">Android端</option><option value="3">PC端</option><option value="4">WAP</option><option value="5">未知</option>'},

...
<script>
    ...
    $("#<?php echo $id;?>").DataSource({url:'order/getdzlist',
        fields:[[
            {field:'bet_time',       title:'投註時間',align:'center', width:140,sortable:false},
            {field:'order_num',      title:'注單號',align:'center', width:140,sortable:false},
            {field:'a',              title:'桌號',align:'center', width:100,sortable:false},
            {field:'b',              title:'遊戲ID',align:'center', width:90,sortable:false},
            {field:'c',              title:'下注結果',align:'center',  width:100,sortable:false},
            {field:'d',              title:'系統賬號',align:'center',  width:120,sortable:false},
            {field:'e',              title:'視訊賬號',align:'center', width:140,sortable:false},
            {field:'f',              title:'投注IP',align:'center', width:100,sortable:false},
            {field:'g',              title:'總投注',align:'center', width:120,sortable:false},
            {field:'h',              title:'有效投注',align:'center', width:120,sortable:false},
            {field:'i',              title:'反水',align:'center', width:80,sortable:false,},
            {field:'price_diff',     title:'結果',align:'center', width:120,sortable:false,
                styler:function(v){

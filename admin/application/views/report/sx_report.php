...
<script>
    $("#<?php echo $id;?>").DataSource({url:'report/get_sx_list?time_start=<?php echo $time_start. '&time_end='.$time_end .'&form_type=' .$form_type. '&level_id=' .$level_id. '&username=' .$username. '&uid=' .$uid. '&agent_id=' .$agent_id;?>',
        fields:[
            [

...
<script>
    $("#<?php echo $id;?>").DataSource({url:'report/get_user_sx_list?time_start=<?php echo $time_start. '&time_end='.$time_end .'&form_type=' .$form_type. '&level_id=' .$level_id. '&username=' .$username. '&uid=' .$uid. '&agent_id=' .$agent_id;?>',
        fields:[
            [
                {field:'name',title:'会员名稱',rowspan:2,align:'center',width:130,sortable:false},
                ...
                {title:'公司交收(紅色代表虧損,綠色代表盈利,反水沒有計算到盈虧)',colspan:2,align:'center',width:340}
             ],[
                {field:'cor_valid_price',title:'總有效下註',align:'center',width:170,  sortable:false},
                ...
                {field:'cor_diff_price',title:'公司實際盈虧',align:'center',width:170,  sortable:false,
                    styler:function(v){
                        return v<=0?'background-color:#F8F8F8;color:#FF0000;':'background-color:#F8F8F8;color:#009900;';
                    }
                }
